...
SECRET_KEY = 'django-insecure-0#c@1ci*o#7i^pk7*l86b)zb$juzo-$s(su@h42*b&mas3lx)_'
...
MEDIA_URL = '/media/'  # URL para acceder a los archivos en desarrollo
...
FILE_UPLOAD_MAX_MEMORY_SIZE = 26214400  # 25MB tamaño máximo en memoria
